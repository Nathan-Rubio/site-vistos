export const informacoes = [
  {
    ...
    <div class="turismo-container">
      ...
      <ul class="lista">
        ...
        <li>
          1 Foto 3×4 cm recente;
        </li>

        <li>
          Passagem ou reserva aérea;
        </li>

        <li>
          Voucher de todos os hotéis onde se hospedará;
        </li>

        <li>
          Cronograma de viagem detalhando os pontos turísticos que serão visitados;
        </li>
        ...
        <li>
          Recomendamos a contratação do seguro viagem, devido ao alto custo de tratamento médico do país. 
          Clique Aqui para solicitar a cotação.
        </li>
      </ul>
    ...
    informacoes: `
      <div class="turismo-container">
        ...
        <ul class="lista">
          ...
          <li>
            02 Fotos 3×4 cm recente (fundo branco e sem acessórios);
          </li>
